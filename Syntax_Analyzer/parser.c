...
{
  "$end", "error", "$undefined", "ID", "INTEGER", "OPERATOR",
  "PUNCTUATION", "KEYWORD", "DOUBLE", "CHAR", "STR", "SINGLE_LINE_COMMENT",
  "MULTI_LINE_COMMENT", "NESTED_COMMENT", "'='", "','", "'+'", "'-'",
  "'*'", "'/'", "UMINUS", "'('", "')'", "$accept", "program", YY_NULL
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     265,   266,   267,   268,    61,    44,    43,    45,    42,    47,
     269,    40,    41
};
# endif
