...
funcdef: 	FUNCTION { funcname = "NO_ID"; Handle_funcdef_function_l_parenthesis_idlist_r_parenthesis_block(funcname ,scope_count, yylineno);} L_PARENTHESIS {scope_count++;} idlist R_PARENTHESIS block { scope_count--; }
